 ...
 */
if ( ! function_exists( 'rtp_library_get_all_fonts' ) ) :
	 ...
	 */
	function rtp_library_get_all_fonts() {

		$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'foodmania' ) ) ) );
		$standard_fonts = rtp_library_get_standard_fonts();

		$heading2      = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Theme Default', 'foodmania' ) ) ) );
		$theme_default = array(
			'candlescript_demo_versionRg' => array(
				'label' => _x( 'candlescript', 'font style', 'foodmania' ),
				'stack' => 'candlescript_demo_versionRg',
			),
		);

		$heading3     = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'foodmania' ) ) ) );
		$google_fonts = rtp_library_get_google_fonts();
		 ...
		 * @return array The fonts in value/label pairs.
		 */
		return apply_filters( 'rtp_library_all_fonts', array_merge( $heading1, $standard_fonts, $heading2, $theme_default, $heading3, $google_fonts ) );
	}

endif;

if ( ! function_exists( 'rtp_library_get_font_choices' ) ) :
	 ...
	 * @return array The fonts in value/label pairs.
	 */
	function rtp_library_get_font_choices() {

		$fonts   = rtp_library_get_all_fonts();
		$choices = array();
...
if ( ! function_exists( 'rtp_library_get_google_font_uri' ) ) :

	/**
	 * Build the HTTP request URL for Google Fonts.
	 *
	 * @param string $key         Theme modification name.
	 * @param string $default     Theme modification default value.
	 * @param string $variant_key Theme modification name.
	 * @param string $subset_key  Theme modification name.
	 *
	 * @return string The URL for including Google Fonts.
	 *
	 * @since 1.0.0.
	 */
	function rtp_library_get_google_font_uri( $key, $default, $variant_key, $subset_key ) {

		$font = trim( get_theme_mod( $key, $default ) );

		// De-dupe the fonts.
		$allowed_fonts = rtp_library_get_google_fonts();
		...
		$family = rawurlencode( $font . ':' . $variant );
		...
		$subsets = ( 'latin' !== $subset ) ? array( 'latin', $subset ) : array( 'latin' );
...
if ( ! function_exists( 'rtp_get_google_fonts_variants' ) ) :
	 ...
	 * @param  boolean $font_name Optional. The condition so that it will either have true or the them modification value for $font.
	 *
	 * @return array variant array
	 */
	function rtp_get_google_fonts_variants( $key, $default, $font_name = false ) {

		$font = $font_name ? $font_name : get_theme_mod( $key, $default );

		$fonts = rtp_library_get_google_fonts();
...
if ( ! function_exists( 'rtp_get_google_fonts_subsets' ) ) :
	 ...
	 * @param string  $key theme_mod key of font.
	 * @param string  $default default font.
	 * @param boolean $font_name Optional. Take user value or get theme mod value.
	 *
	 * @return [array] variant array
	 */
	function rtp_get_google_fonts_subsets( $key, $default, $font_name = false ) {
...
if ( ! function_exists( 'rtp_library_get_standard_fonts' ) ) :
	 ...
	 */
	function rtp_library_get_standard_fonts() {

		return array(
			'serif'      => array(
				'label' => _x( 'Serif', 'font style', 'foodmania' ),
				'stack' => 'Georgia,Times,"Times New Roman",serif',
			),
			'sans-serif' => array(
				'label' => _x( 'Sans Serif', 'font style', 'foodmania' ),
				'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif',
			),
			'monospace'  => array(
				'label' => _x( 'Monospaced', 'font style', 'foodmania' ),
...
if ( ! function_exists( 'rtp_library_get_font_stack' ) ) :
	 ...
	 */
	function rtp_library_get_font_stack( $font ) {

		$all_fonts = rtp_library_get_all_fonts();

		// Sanitize font choice.
		$font = rtp_library_sanitize_font_choice( $font );
...
if ( ! function_exists( 'rtp_library_sanitize_font_choice' ) ) :
	 ...
	 */
	function rtp_library_sanitize_font_choice( $value ) {

		if ( is_int( $value ) ) {
			// The array key is an integer, so the chosen option is a heading, not a real choice.
			return '';
		} elseif ( array_key_exists( $value, rtp_library_get_font_choices() ) ) {
			return $value;
		} else {
			return '';
		}
...
if ( ! function_exists( 'rtp_library_get_google_fonts' ) ) :
	 ...
	 */
	function rtp_library_get_google_fonts() {
		return apply_filters(
			'rtp_library_get_google_fonts',
			array(
				'ABeeZee'                  => array(
					'label'    => 'ABeeZee',
					'variants' => array(
